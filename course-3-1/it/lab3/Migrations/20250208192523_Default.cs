    ...
    public partial class Default : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomVisitor", x => new { x.RoomsId, x.VisitorsId });
                    table.ForeignKey(
                        name: "FK_RoomVisitor_Rooms_RoomsId",
                        column: x => x.RoomsId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomVisitor_Visitors_VisitorsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomVisitor_VisitorsId",
                table: "RoomVisitor",
                column: "VisitorsId");
        }
